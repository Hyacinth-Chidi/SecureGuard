      ...
      <header className="sticky top-0 z-50 bg-background/70 backdrop-blur-xl border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Image src="/assets/logo.png" alt="SecureGuard Logo" width={36} height={36} className="rounded-lg shadow-primary-glow/20 shadow-md" />
      ...
      <main className="flex-grow">
        ...
        <section className="relative max-w-7xl mx-auto px-6 pt-32 pb-40 text-center overflow-hidden">
          ...
          <p className="text-lg md:text-2xl text-text-muted max-w-3xl mx-auto mb-12 leading-relaxed font-light">
            Train your employees, run hyper-realistic phishing campaigns, and measure your organization's risk—all from one secure, isolated command center.
          </p>
        ...
        <section id="features" className="bg-surface py-32 border-y border-border relative">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-20">
              <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-6">Everything you need to secure your team</h2>
              <p className="text-xl text-text-muted max-w-2xl mx-auto font-light">Our platform provides enterprise-grade tools designed for organizations of all sizes.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <FeatureCard 
                ...
                description="Instantly assign targeted educational modules when employees fall for simulations."
              />
              <FeatureCard 
                icon={<Users className="w-8 h-8 text-warning" />}
                title="Multi-Tenant Spaces"
                description="Dedicated, isolated workspaces for every organization with private branding."
              />
              <FeatureCard 
                icon={<BarChart3 className="w-8 h-8 text-danger" />}
                title="Actionable Reports"
                description="Track risk metrics, campaign performance, and training completion rates in real-time."
              />
            </div>
          </div>
        </section>
