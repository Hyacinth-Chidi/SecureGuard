  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-paper">
      <div className="w-full max-w-sm">
        ...
        <h2 className="font-display text-2xl font-semibold text-slate-dark text-center">Join your workspace</h2>
        <p className="text-sm text-slate mt-1.5 mb-7 text-center">
          Create your employee account to access assigned awareness training.
        </p>

        {token ? (
          <JoinForm orgSlug={organization.slug} token={token} />
        ) : (
          <p className="rounded-lg border border-coral/20 bg-coral/10 px-3 py-2 text-sm text-coral">
